...
# Assign price fluctuation with change of arrow
...
if abs(diff_percent) > .5:
    ...
    # Pull 3 most recent news articles if absolute price change is triggered
    news_response = requests.get(NEWS_ENDPOINT, params=news_params)
    news_response.raise_for_status()
    news_data = news_response.json()["articles"]
    
    # Format and partition out news data to send
    ...
    # Utilize Twilio messaging system to send an automated text
